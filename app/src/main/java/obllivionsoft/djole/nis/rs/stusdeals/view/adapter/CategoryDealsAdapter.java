...
public class CategoryDealsAdapter extends RecyclerView.Adapter<CategoryDealsAdapter.MyViewHolder> {
    Context context;
    ...
    public CategoryDealsAdapter(AppCompatActivity context, List<DealsCustomModel> allDealsList, CategoryDealsAdapter.onItemClickListner onItemClickListner) {
        this.context = context;
        this.onItemClickListner = onItemClickListner;
        this.mList = allDealsList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        String provider = mList.get(i).getProvider_name();
//        String startDay=mList.get(i).getStartDay();
//        String endDay=mList.get(i).getEndDay();
//        if(!startDay.isEmpty()&&!endDay.isEmpty())
//        {
//            holder.tvDay.setText(startDay+" To " +endDay);
//        }
//        else{
//            holder.tvDay.setText(startDay+endDay);
//        }
        ...
        if (!provider.isEmpty()) {
            holder.tvProviderName.setText(provider);
        }
