...
public class SubCategoryDealAdapter extends RecyclerView.Adapter<SubCategoryDealAdapter.MyViewHolder> {
    ...
    public SubCategoryDealAdapter(AppCompatActivity mContext, List<DealsCustomModel> mSubDealsList, SubCategoryDealAdapter.onItemClickListner onItemClickListner) {
        this.context = mContext;
        this.onItemClickListner = onItemClickListner;
        this.mList = mSubDealsList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        String provider_name = mList.get(i).getProvider_name();
